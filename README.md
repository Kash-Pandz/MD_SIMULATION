...
The input protein structure is cleaned using pdbfixer, which removes unwanted crystallographic waters and ligand species. An AMBER FF was used in `prepare_protein_only_system.py`, but the CHARMM FF can also be used.
